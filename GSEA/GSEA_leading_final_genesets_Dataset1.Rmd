...
#for Xenium we start from the h5ad file (this is specified for Dataset 1).We want to convert the h5ad file to a Seurat obj, first part to generate matrix files in the notebook named "first_steps_to_convert_h5ad_to_seurat.ipynb"
...
# Note: Genes not present in Dataset 3 plex were removed (TFF, CST3, FCN1)

# IMPORTANT:
# - Fill in gene names manually (in quotation marks, separated by commas)
# - Gene signature lists are available in our manuscript
# - We will update this notebook with full gene lists once the manuscript is public
# Example format:
# c("GENE1", "GENE2", "GENE3")

custom_gene_sets <- list(
  GeneSet_R = c("GENE1", "GENE2", "GENE3"),
  GeneSet_IAF_Monocyte_Neutrophil = c("GENE1", "GENE2", "GENE3"),
  GeneSet_GALT_B_DC_S4_fibroblast = c("GENE1", "GENE2", "GENE3")
)
```
